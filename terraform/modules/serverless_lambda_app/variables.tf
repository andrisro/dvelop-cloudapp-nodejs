...
variable "lambda_root_file" {
  description = "Path to ZIP file with lambda root function"
}

variable "lambda_featuresdescription_file" {
  description = "Path to ZIP file with featuresdescription function"
}
